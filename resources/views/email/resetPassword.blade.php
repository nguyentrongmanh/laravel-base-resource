                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            align="left">
                                                            <h3
                                                                style="margin: 0px; color: #868686; line-height: 170%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Cabin',sans-serif; font-size: 16px;">
                                                                このメールは、あなたのアカウントのパスワード リセット リクエストを受け取ったためにお送りしています。
                                                            </h3>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div align="center">
                                                                <a href="{{$url}}" target="_blank"
                                                                    class="v-size-width"
                                                                    style="box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #181147; border-radius: 1px;-webkit-border-radius: 1px; -moz-border-radius: 1px; width:50%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                                                    <span
                                                                        style="display:block;padding:10px 10px 10px 10px;line-height:120%;"><span
                                                                            style="font-family: Cabin, sans-serif; font-size: 14px; line-height: 21.6px;"><strong><span
                                                                                    style="line-height: 21.6px; font-size: 14px;"><span
                                                                                        style="line-height: 21.6px; font-size: 14px;">パスワードを再設定する</span></span></strong></span></span>
                                                                </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 180%;"><span
                                                                        style="font-family: Cabin, sans-serif; font-size: 14px; line-height: 180%;">このパスワード リセット リンクは 60 分で期限切れになります。<br/>パスワードのリセットを要求していない場合は、これ以上の操作は必要ありません。
                                                                    </p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                style="color: #868686; line-height: 180%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 180%;"><span
                                                                        style="font-family: Cabin, sans-serif; font-size: 14px; line-height: 180%;">[パスワードのリセット] ボタンをクリックできない場合は、次の URL をコピーして Web ブラウザーに貼り付けます:</span>
