              ...
              <form method="POST" @submit.prevent="submit">
                <div class="input-group mb-3">
                  ...
                  <input
                    ...
                    v-model="email"
                  />
                  <div class="invalid-feedback" :class="{ 'd-block' : errors.first('email') }" role="alert">
                    {{ errors.first("email") }}
                  </div>
                  <div
                ...
                <div class="input-group mb-4">
                  ...
                  <input
                    ...
                    v-model="password"
                  />
                  <div class="invalid-feedback"  :class="{ 'd-block' : errors.first('password') }" role="alert">
                  ...
                  <div class="invalid-feedback d-block" v-if="errorsData" role="alert">
                    {{ errorsData }}
                  </div>
                </div>
                <div class="row"></div>
